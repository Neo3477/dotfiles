...
local function setup(st, opts)
	...
	local styles = {
		[6] = t.modified and ui.Style(t.modified) or ui.Style():fg("#fabd2f"),
		[5] = t.added and ui.Style(t.added) or ui.Style():fg("#b8bb26"),
		[4] = t.untracked and ui.Style(t.untracked) or ui.Style():fg("#8ec07c"),
		[3] = t.ignored and ui.Style(t.ignored) or ui.Style():fg("#d3869b"),
		[2] = t.deleted and ui.Style(t.deleted) or ui.Style():fg("#fb4934"),
		[1] = t.updated and ui.Style(t.updated) or ui.Style():fg("#83a598"),
	}
	local signs = {
